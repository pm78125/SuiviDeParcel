...
window.toggleModeAjout = function() {
    ...
    if (modeAjout) {
        ...
        if (btn) {
            btn.innerHTML = '<span class="btn-label">Annuler</span>';
        ...
        if (btn) {
            btn.innerHTML = '<svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14M5 12h14"/></svg><span class="btn-label">Ajouter un arbre</span>';
